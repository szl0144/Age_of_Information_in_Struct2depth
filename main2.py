...
def main():
    ...
    plt.title('Training Loss Changes')
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    plt.legend()
    plt.show()
    ...
    for loader_idx, (image_stack, image_stack_norm, intrinsic_mat, _) in enumerate(valid_dataloader):
    ...
    valid_loss = valid_loss /loader_idx
